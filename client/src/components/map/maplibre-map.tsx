  ...
  return (
    <div className={cn("relative w-full h-full overflow-hidden", className)} data-testid="maplibre-container">
      ...
      >
        ...
        >
          <Map size={18} className="text-black" strokeWidth={2.5} />
        </button>
        {/* 3. Recenter */}
        <button
        ...
        <button
          ...
          aria-label="Zoom out"
        >
          <Minus size={18} className="text-black" strokeWidth={2.5} />
        </button>
        {/* 6. Compass */}
        {!hideCompass && (
          <button
          ...
          >
            <Compass size={18} className="text-black" strokeWidth={2.5} style={{ transform: `rotate(${bearing}deg)`, transition: 'transform 300ms' }} />
          </button>
        )}
        {/* 7. 3D Toggle */}
        <button
        ...
        >
          <Box size={18} className="text-black" strokeWidth={2.5} />
        </button>
        {/* 8. Traffic Toggle */}
        {onToggleTraffic && (
          <button
          ...
          >
            <Layers size={18} className="text-black" strokeWidth={2.5} />
          </button>
        )}
      </div>
