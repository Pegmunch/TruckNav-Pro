  ...
  return (
    <>
      ...
      <Button
        ...
        className="h-16 w-16 rounded-xl bg-red-500 hover:bg-red-600 text-white shadow-lg"
      ...
      <Button
        ...
        className={`h-16 w-16 rounded-xl shadow-lg transition-all ${
          isVoiceSupported
            ? isVoiceListening 
      ...
      <Button
        ...
        className="h-16 w-16 rounded-xl bg-orange-500 hover:bg-orange-600 text-white shadow-lg"
      ...
      <Button
        ...
        className="h-16 w-16 rounded-xl bg-blue-600 hover:bg-blue-700 text-white shadow-lg mt-8"
