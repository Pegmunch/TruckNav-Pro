  ...
  return (
    <>
      ...
      <Button
        ...
        className="h-3 w-3 rounded-xl bg-red-500 hover:bg-red-600 text-white shadow-lg"
      ...
      {isVoiceSupported && (
        <Button
          ...
          className={`h-3 w-3 rounded-xl shadow-lg transition-all ${
            isVoiceListening 
      ...
      <Button
        ...
        className="h-3 w-3 rounded-xl bg-orange-500 hover:bg-orange-600 text-white shadow-lg"
      ...
      <Button
        ...
        className="h-3 w-3 rounded-xl bg-blue-600 hover:bg-blue-700 text-white shadow-lg mt-8"
