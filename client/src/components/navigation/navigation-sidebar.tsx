...
const NavigationSidebar = memo(function NavigationSidebar({
  ...
  return (
    <>
      <div
        className={cn(
          "fixed top-1/2 -translate-y-1/2 z-[45] transition-all duration-300 ease-in-out",
          isOpen 
      ...
      >
        ...
        >
          <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 24 24" fill="none" stroke="#2563eb" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ flexShrink: 0 }}>
