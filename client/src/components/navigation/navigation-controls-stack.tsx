  ...
  return (
    <>
      ...
      <Button
        ...
        className="h-14 w-14 rounded-xl bg-white hover:bg-gray-50 shadow-lg border border-gray-200"
      ...
      <Button
        ...
        className={`h-14 w-14 rounded-xl shadow-lg backdrop-blur-sm border ${
          map3DMode 
