  ...
  return (
    <>
      ...
      <Button
        ...
        className="h-3 w-3 rounded-xl bg-white hover:bg-gray-50 shadow-lg border border-gray-200"
      ...
      >
        ...
        >
          <Compass className="h-2 w-2 text-blue-600" />
        </div>
      </Button>
      ...
      <Button
        ...
        className={`h-3 w-3 rounded-xl shadow-lg backdrop-blur-sm border ${
          map3DMode 
