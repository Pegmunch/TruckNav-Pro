  ...
  return (
    <>
      ...
      <Button
        ...
        className="h-16 w-16 rounded-xl bg-white hover:bg-gray-50 shadow-lg border border-gray-200"
      ...
      >
        ...
        >
          <Compass className="h-9 w-9 text-blue-600" />
        </div>
      </Button>
      ...
      <Button
        ...
        aria-label="Zoom in"
      >
        <Plus className="h-9 w-9 text-gray-700" />
      </Button>
      ...
      <Button
        ...
        aria-label="Zoom out"
      >
        <Minus className="h-9 w-9 text-gray-700" />
      </Button>
      ...
      <Button
        ...
        className={`h-16 w-16 rounded-xl shadow-lg backdrop-blur-sm border ${
          map3DMode 
