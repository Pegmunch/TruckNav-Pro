...
export function NavigationControlsStack({
  ...
  return (
    <>
      ...
      {/* 6. Satellite View Toggle - Green when active, gray when inactive */}
      <Button
        variant="ghost"
        size="icon"
        onClick={() => {
          console.log('[RIGHT-BTN-6-SATELLITE] ✅ Satellite clicked - Current:', mapViewMode);
          onToggleMapView();
        }}
      ...
      <Button
        ...
        size="icon"
        onClick={() => {
          console.log('[RIGHT-BTN-8-3D] ✅ 3D Mode clicked - Current:', map3DMode);
          onToggle3D();
        }}
        className={`h-8 w-8 rounded-xl shadow-lg ${
          map3DMode 
