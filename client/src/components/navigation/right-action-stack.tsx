...
export function RightActionStack({
  ...
  return (
    ...
    >
      ...
      {/* 4. Zoom In - ALWAYS VISIBLE (never hides on double-tap) - Blue border during navigation */}
      {onZoomIn && (
        <Button
          variant="ghost"
          size="icon"
      ...
      {/* 5. Zoom Out - ALWAYS VISIBLE (never hides on double-tap) - Blue border during navigation */}
      {onZoomOut && (
        <Button
          variant="ghost"
          size="icon"
