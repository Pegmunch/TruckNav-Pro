        ...
        {(isNavigating || isPreviewActive) && (
          <div className="flex items-center gap-1.5 md:gap-3 flex-shrink-0">
            ...
            <div className={cn(
              ...
              <span className="text-[11px] md:text-lg font-bold text-gray-900 dark:text-white">{convertedSpeedLimit || '--'}</span>
            </div>
      ...
      <div className="flex items-center justify-between gap-2 md:gap-4">
        ...
        <div className="flex items-center gap-1.5 md:gap-3 flex-1 justify-center min-w-0">
          ...
          {(turnInfo || (laneInfo && laneInfo.lanes.length > 0)) && (
            <div className="flex items-center gap-1.5 md:gap-2 bg-gray-100/90 dark:bg-gray-800/90 px-2 md:px-3 py-1 md:py-1.5 rounded-lg shadow-sm border border-blue-500">
              ...
              {turnInfo && (
                <span className="text-xs md:text-base font-bold text-gray-900 dark:text-white ml-0.5">
