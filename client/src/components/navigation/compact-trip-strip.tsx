          ...
          {!isNavigating && (
            <div className="flex flex-row items-center gap-0.5">
              <button
                ...
                className="h-4 px-1.5 bg-blue-600 hover:bg-blue-700 text-white font-semibold text-[8px] active:scale-95 transition-all disabled:opacity-40 rounded-l-full shadow-sm flex items-center justify-center"
              ...
              <button
                ...
                disabled={!isPreviewActive}
                className="h-4 px-1.5 bg-rose-500 hover:bg-rose-600 text-white font-semibold text-[8px] active:scale-95 transition-all disabled:opacity-40 rounded-r-full shadow-sm flex items-center justify-center"
