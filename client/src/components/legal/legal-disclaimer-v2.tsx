...
interface LegalDisclaimerV2Props {
...
/**
 * Legal Disclaimer V2 - Mobile-optimized version
 * Features quick accept button, responsive design, and simplified flow
 */
export default function LegalDisclaimerV2({ onClose, onVersionSwitch }: LegalDisclaimerV2Props) {
  // Mobile detection
  ...
  return (
    ...
    <div className="fixed inset-0 z-[9999] isolate">
      ...
      <div 
        ...
        data-testid="legal-disclaimer-v2"
      >
            ...
            <div className="flex items-center gap-2">
              ...
              {onVersionSwitch && (
                <Button 
                  ...
                  data-testid="button-switch-version-mobile"
                >
                  v1
                </Button>
              )}
